...
class HformVandUV extends StatefulWidget {
  const HformVandUV({super.key});
  @override
  State<HformVandUV> createState() => _HformVandUVState();
}
class _HformVandUVState extends State<HformVandUV> {
                                  ...
                                  children: [
                                    ...
                                    TextButton(
                                      onPressed: (){
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => new HformsAtoZ())
                                        );
                                      },
                                      child: Text(
                                        "A - Z",
                                    ...
                                    TextButton(
                                      onPressed: (){
                                        Navigator.push(
                                            context,
                                            MaterialPageRoute(builder: (context) => new HformsDate())
                                        );
                                      },
                                      child: Text(
                                        "Date Created",
                                    ...
                                    Container(
                                      ...
                                      child: TextButton(
                                          onPressed: ()=>{
                                            Navigator.push(
                                                context,
                                                MaterialPageRoute(builder: (context) => new Hpatient())
                                            )
                                          },
                                          child: Text(
                                            "View",
